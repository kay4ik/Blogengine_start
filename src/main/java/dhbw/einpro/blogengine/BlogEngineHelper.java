...
public final class BlogEngineHelper
{
     ...
     * @return
     */
    public static IPost createPost(String titel, String content, IUser user)
    {
        return new Post(titel, content, user);
    }
     ...
     * @param author
     * @return
     * throws IllegalOperationException Exception wird ausgelöst, falls der Inhalt des Kommentars mehr als 256 Zeichen umfasst.
     */

...
public class App
{
     ...
     *
     * @return Neue Post-Instanz throws DuplicateUserException thorws
     *         DuplicateEmailException
     */
    public static final Post createPost() throws DuplicateUserException, DuplicateEmailException, IllegalOperationException {
        User l_user1 = new User("Max", "Mustermann", "max.mustermann@mail.de");

        BlogEngineHelper.getDefaultBlogEngine().addUser(l_user1);

        Post l_post1 = new Post("Title des Posts1", "Content des Posts1", l_user1);
    ...
    public static final IComment addComment()
            throws DuplicateUserException, DuplicateEmailException, IllegalOperationException
    {
        User l_user1 = new User("Max", "Mustermann", "max.mustermann@mail.de");
        ...
        Post l_post1 = new Post("Titel 1", "Inhalt von Post 1", l_user1);
        Post l_post2 = new Post("Titel 2", "Inhalt von Post 2", l_user2);

...
public interface IBlogEngine
{
     ...
     * 
     * @param p_user Benutzer, der aus dem Blog-System entfernt werden soill
     ...
     */
    int addPost(IPost p_post) throws IllegalOperationException;
    ...
    /**
     * Prüft, ob ein Benutzer mit der angegebenen Email-Adresse im Blog-System
     * existiert.
     *
     * @param p_email Emal-Adresse des gesuchten Benutzers
     * @return true falls der Benutzer gefunden wurde
     */
    boolean containsUser(String p_email);
     ...
     */
    List<IPost> findPostsByTitle(String titel);
}
